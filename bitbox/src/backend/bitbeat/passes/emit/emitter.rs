...
impl Lower<BitbeatLowerContext<'_>> for crate::ir::Instruction {
    ...
    fn lower(
        ...
        match self {
            ...
            crate::ir::Instruction::And(iand) => iand.lower(ctx, target)?,
            crate::ir::Instruction::Or(ior) => ior.lower(ctx, target)?,
...
impl Lower<BitbeatLowerContext<'_>> for crate::ir::Operand {
    ...
    fn lower(
        ...
        match self {
            ...
            crate::ir::Operand::ConstantInt(constant) => {
                Ok(OperandResult::Value(constant.parse::<i64>()?))
            }
