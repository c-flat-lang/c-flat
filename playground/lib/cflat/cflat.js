...
export class Cli {
    ...
    free() {
        ...
        wasm.__wbg_cli_free(ptr, 0);
    }
    /**
     * @returns {DebugMode | undefined}
     */
    get debug_mode() {
    ...
    get file_path() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cli_file_path(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     * @param {DebugMode | null} [debug_mode]
     */
     ...
     */
    get target() {
        const ret = wasm.cli_target(this.__wbg_ptr);
        return ret;
    }
}
...
export const Target = Object.freeze({
    Wasm32: 0, "0": "Wasm32",
    X86_64Linux: 1, "1": "X86_64Linux",
    Bitbeat: 2, "2": "Bitbeat",
});

/**
 * @param {string} source
 * @param {Cli} cli_options
 * @returns {Uint8Array}
 */
export function compile_source(source, cli_options) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    _assertClass(cli_options, Cli);
    var ptr1 = cli_options.__destroy_into_raw();
    const ret = wasm.compile_source(ptr0, len0, ptr1);
    if (ret[2]) {
...
const CliFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_cli_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cflat_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
